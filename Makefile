...
deploy-ci:
	cd src/backend/infra;terraform init;terraform apply -var="live_image_tag=${IMAGE_TAG}" -var="repository=${GCP_REGION}-docker.pkg.dev/serverless-sandbox-429409/cloud-run-source-deploy/gcloud-go" -auto-approve
